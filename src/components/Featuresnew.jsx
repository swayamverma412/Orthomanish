    ...
    <div id='features' className='text-center'>
      ...
      spacing={3} xs={12} sm={12} md={12} lg={12}>
        ...
        <Grid item xs={12} sm={12} md={3} lg={3}>
          ...
          <h3 style={{color:'black', textAlign:'center',fontSize:'30px'}}>Arthroplasty</h3>
          <p style={{textAlign:'center'}}>Assisted over 90 Arthroplasty of Hip, Knee & Shoulders.</p>
                                      
        </Grid>
        <Grid item xs={12} sm={12} md={3} lg={3}>
          <img src={pic80} alt="pic80" style={{display: "flex", justifyContent: "center", alignItems: "center",margin:"0 auto"}}/>
          <h3 style={{color:'black', textAlign:'center',fontSize:'30px'}}>Surgeries</h3><br></br>
        ...
        <Grid item xs={12} sm={12} md={3} lg={3}>
          ...
          <h3 style={{color:'black', textAlign:'center',fontSize:'30px'}}>Arthroscopy</h3><br></br>
           <p style={{textAlign:'center'}}>Performed over 40 Diagosnitic Arthroscopy and 8 Arthroscopic ACL repairs.</p> 
        </Grid>
        </Grid>
    </div>
  );
